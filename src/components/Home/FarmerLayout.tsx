...
const farmerItems = [
  ...
  { label: 'Profile', to: 'profile', icon: (
    <svg className="shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
      <path fill="currentColor" d="M12 4a4 4 0 1 0 0 8 4 4 0 0 0 0-8Zm-2 9a4 4 0 0 0-4 4v1a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2v-1a4 4 0 0 0-4-4h-4Z" clipRule="evenodd"/>
    </svg>
  ) },
];
...
const FarmerLayout = () => {
  ...
  return (
    <>
      ...
      <Sidebar items={farmerItems} isOpen={isSidebarOpen} onClose={() => setIsSidebarOpen(false)}/>
      <Outlet />
    </>
  );
};
